...
namespace WGU_ESS.API.Migrations
{
    ...
    [Migration("20210715201006_Add-Reminder-Time")]
    partial class AddReminderTime
    {
            ...
            modelBuilder.Entity("WGU_ESS.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7267a7db-7bd3-45c4-869c-5d72804634ca"),
                            CreationTime = new DateTime(2021, 7, 15, 20, 10, 6, 9, DateTimeKind.Utc).AddTicks(8519),
                            FirstName = "Super",
                            IsHidden = false,
                            IsLocked = false,
                            LastName = "User",
                            ModificationTime = new DateTime(2021, 7, 15, 20, 10, 6, 9, DateTimeKind.Utc).AddTicks(8742),
